                ...
                <div class="migration-summary">
                    <?php if ($sync_results['synced'] > 0): ?>
                        <div class="success-notice">
                            ...
                            <p><?php printf(__('%d tournaments had their player data synchronized successfully.', 'poker-tournament-import'), $sync_results['synced']); ?></p>
                    ...
                    <?php if ($sync_results['failed'] > 0): ?>
                        <div class="error-notice">
                            ...
                            <p><?php printf(__('%d tournaments could not be synced.', 'poker-tournament-import'), $sync_results['failed']); ?></p>
                            ...
                            <?php if (!empty($sync_results['errors'])): ?>
                                ...
                                <ul>
                                    ...
                                    <?php if (count($sync_results['errors']) > 10): ?>
                                        <li><?php printf(__('... and %d more errors', 'poker-tournament-import'), count($sync_results['errors']) - 10); ?></li>
                                    <?php endif; ?>
                                </ul>
                            <?php endif; ?>
