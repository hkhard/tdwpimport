	...
	private static function insert_default_notification_sounds( $wpdb ) {
		...
		$sounds = array(
			array(
				...
				'file_path' => plugin_dir_path( dirname( __FILE__ ) ) . 'assets/sounds/bell.wav',
				'file_url' => plugin_dir_url( dirname( __FILE__ ) ) . 'assets/sounds/bell.wav',
				'category' => 'tournament',
				'is_default' => 1,
			),
			array(
				...
				'file_path' => plugin_dir_path( dirname( __FILE__ ) ) . 'assets/sounds/bustout.wav',
				'file_url' => plugin_dir_url( dirname( __FILE__ ) ) . 'assets/sounds/bustout.wav',
			...
			array(
				...
				'file_path' => plugin_dir_path( dirname( __FILE__ ) ) . 'assets/sounds/final-table.wav',
				'file_url' => plugin_dir_url( dirname( __FILE__ ) ) . 'assets/sounds/final-table.wav',
				'category' => 'milestone',
				'is_default' => 1,
			),
			array(
				...
				'file_path' => plugin_dir_path( dirname( __FILE__ ) ) . 'assets/sounds/registration.wav',
				'file_url' => plugin_dir_url( dirname( __FILE__ ) ) . 'assets/sounds/registration.wav',
