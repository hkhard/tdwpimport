<?php
/**
 * Stats Tab Content (Stub for Week 4)
 *
...
<div class="stats-tab-content stub-content">
	<div class="stub-message">
		<h2><?php esc_html_e( 'Live Statistics & Reporting', 'poker-tournament-import' ); ?></h2>
		<p class="description"><?php esc_html_e( 'Coming in Phase 2 Week 4', 'poker-tournament-import' ); ?></p>
